<div class="ms-parts-search">
  ...
  <div class="ms-parts-search__visual">
    <div class="ms-parts-search__overlay"></div>
    <div class="ms-parts-search__content">
      <h2 class="ms-parts-search__title">{l s='Recherche de pièces compatibles' d='Shop.Theme.Global'}</h2>
      <p class="ms-parts-search__desc">{l s='Recherchez des pièces détachées pour partie cycle, partie moteur et accessoires powerparts compatible avec votre moto KTM, Husqvarna et GasGas parmi plus de 40 000 références.' d='Shop.Theme.Global'}</p>
      <img src="{$urls.theme_assets}img/brands/KTM_HUSQVARNA_GASGAS_LOGO.png" alt="KTM · Husqvarna · GasGas" class="ms-parts-search__brands" loading="lazy">
    </div>
  </div>

  {* ── Volet droit — formulaire ── *}
  <div class="ms-parts-search__panel">

    {* Onglets *}
    <div class="ms-parts-search__tabs">
      <button type="button" class="ms-parts-search__tab is-active" data-tab="model">
        ...
        <span>{l s='Recherche par modèle' d='Shop.Theme.Global'}</span>
      </button>
      <button type="button" class="ms-parts-search__tab" data-tab="vin">
        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 25 23" fill="none" aria-hidden="true">
        ...
        <span>{l s='Recherche par VIN' d='Shop.Theme.Global'}</span>
      </button>
    </div>

    {* Formulaire par modèle *}
    <form class="ms-parts-search__form is-active" data-form="model" action="#" method="get">

      <div class="ms-parts-search__field">
        <select name="marque" class="ms-parts-search__select">
      ...
      <div class="ms-parts-search__field">
        <select name="annee" class="ms-parts-search__select">
          <option value="" disabled selected>{l s='Année' d='Shop.Theme.Global'}</option>
        </select>
      </div>

      <div class="ms-parts-search__field">
        <select name="gamme" class="ms-parts-search__select">
          <option value="" disabled selected>{l s='Gamme' d='Shop.Theme.Global'}</option>
        </select>
      </div>

      <div class="ms-parts-search__field">
        <select name="modele" class="ms-parts-search__select">
